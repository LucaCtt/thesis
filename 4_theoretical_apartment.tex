\chapter{Theoretical Apartment}\label{ch:theoretical_apartment}
...
\begin{lstlisting}[language=plain,caption={Example of an activation for the fridge},label=lst:activation_example,float,floatplacement=H]
...
\hline
\textbf{Appliance type}          & \textbf{Mode name} & \textbf{Consumption (W)} & \textbf{Duration (s)} \\ \hline
\SetCell[r=2]{l}{Radio}      & stand-by        & 1    & -     \\
                            & on              & 37   & 4435  \\ \hline[dashed]
...
\SetCell[r=2]{l}{Television} & stand-by        & 18   & 2514  \\
                            & on              & 110  & 1833  \\ \hline[dashed]
\SetCell[r=7]{l}{Microwave}  & stand-by        & 5    & -     \\
                            & microwave       & 750  & 300   \\
                            & crisp           & 500  & 300   \\
                            & grill           & 500  & 300   \\
...
\SetCell[r=2]{l}{Desktop}    & suspended       & 4    & -     \\
                            & on              & 41   & 12412 \\ \hline[dashed]
\SetCell[r=3]{l}{Boiler}     & holiday         & 33   & 300   \\
                            & comfort         & 57   & 525   \\
