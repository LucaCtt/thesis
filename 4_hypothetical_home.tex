...
\begin{figure}
  ...
  \caption[Floor plan of a hypothetical case study home with the location of the chosen appliance types.]{Floor plan of a hypothetical case study home with the location of the chosen appliance types. Picture courtesy of Matteo Pigoli.}
...
\begin{figure}
  ...
  \caption[Procedure for identifying the operation modes of appliances]{Procedure for identifying the operation modes of appliances.}
