\begin{lstlisting}[language=numbered,caption={Response to HTTP POST request to the \textit{/simulate} endpoint},label=code:api_response_simulate,float,floatplacement=H]
{
    values: {
        {
