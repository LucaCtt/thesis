...
\begin{table}
    ...
    \resizebox{\textwidth}{!}{%
        \begin{tabular}{lllp{.1\textwidth}l>{\centering}p{.1\textwidth}c>{\centering}p{.14\textwidth}p{.65\textwidth}}
            ...
            12          & DEDDIAG          & 2021          & Germany           & Real-world    & 15                 & 3.5 years       & 8                      & Coffee machine, dishwasher, dryer, freezer, office desk, refrigerator, tv, washing machine \\ \hline
        \end{tabular}}
...
\begin{table}
    ...
    \resizebox{\textwidth}{!}{%
        \begin{tabular}{llccll}
            \hline
            \multirow{2}{*}{\textbf{\#}} & \multirow{2}{*}{\textbf{Dataset}} & \multicolumn{2}{c}{\textbf{Resolution}} & \multirow{2}{*}{\textbf{Features}} & \multirow{2}{*}{\textbf{Applications}}                          \\ \cline{3-4} &  & \textbf{Aggregate} & \textbf{Appliance} &  & \\ \hline
